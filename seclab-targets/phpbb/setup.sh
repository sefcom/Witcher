...
printf "\033[36mAlter the setup manually, goto http://$ipaddr/board/test click on ACP near top left, click on security settings and set:\n"
echo "    Validate sessions = None, Validate browser = None, Validate Referrer = No "
echo "    Login attempt expiration = 10 seconds, Max form time = 99999, Tie forms to guest = False"
printf "\033[0m"

echo "After changes to setup are saved  "
